...
questions_list = [] 
questions_list.append(Question('Национальный язык Португалии','Португальский', 'Бразильский', 'Испанский', 'Итальянский'))
questions_list.append(Question('Корень из 2809','53','28','39','72'))
questions_list.append(Question('Какая из этих стран не находятся в Европе','Гренландия','Россия', 'Италия','Швеция'))
